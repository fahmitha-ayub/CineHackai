...
const Sponsors = () => {  
  ...
  const radioPartners = [  
    {  
      ...
      name: "Red FM",  
      logo: "/red.jpg",  
      website: "https://www.redfmindia.in/delhi-1/home",  
    },  
  ];  
    const tickPartners = [  
    {  
  ...
  >
    <img
      ...
      className="w-24 h-24 object-contain filter brightness-110 group-hover:brightness-125 transition-all duration-300"
      onError={(e) => {
    ...
    <>  
      ...
      <div className="relative bg-gradient-to-b from-gray-900 to-black py-10 border-t border-gray-800/50 overflow-hidden">  
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 md:px-8">  
          ...
          {/* Partners grid */}  
          <div className="flex flex-col md:flex-row items-center justify-center gap-12 text-center flex-wrap">  
            {/* Strategic Partner */}  
            ...
            <div className="relative">  
              <div className="flex items-center justify-center mb-4">  
                <p  
                  className="text-green-400 text-sm font-bold tracking-wider uppercase"  
                  style={{ fontFamily: "RusticRoadway, sans-serif" }}  
                >  
                  Powered By  
                </p>  
            ...
            <div className="relative">  
              <div className="flex items-center justify-center mb-4">  
                <p  
                  className="text-red-400 text-sm font-bold tracking-wider uppercase"  
                  style={{ fontFamily: "RusticRoadway, sans-serif" }}  
                >  
                  Radio Partner  
                </p>  
              ...
              <div className="flex items-center justify-center gap-6 flex-wrap">  
                {radioPartners.map((sponsor, index) => renderSponsorLogo(sponsor, index))}  
              </div>  
            </div> 
...
<div className="relative">
  ...
  <div className="flex items-center justify-center gap-6 flex-wrap">
    {tickPartners.map((sponsor, index) => renderSponsorLogo(sponsor, index))}
  </div>
</div>
